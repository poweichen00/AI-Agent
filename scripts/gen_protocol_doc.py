#!/usr/bin/env python3
"""Generate WIRE_PROTOCOL.md from pydantic models in agentx.core.bus."""
...
# 從 pydantic 模型生成一個帶欄位表、JSON Schema 和可選示例的 Markdown 小節
...
def generate() -> str:
    ...
    agent_run_req_example = {
        ...
        "id": "u-2",
        "method": "agent.run",
        "params": {"goal": "總結 README.md 的主要章節"},
    }
    ...
    session_send_req_example = {
        ...
        "params": {"session_id": session_id, "content": "總結 README.md"},
    }
    ...
    sections = [
        ...
        "## Transport\n\n",
        "- TCP loopback `127.0.0.1:7437` (override via `AGENTX_HOST` / `AGENTX_PORT`)\n",
        ...
        _model_section("RunStartedEvent", RunStartedEvent,
            {"type": "run.started", "run_id": run_id, "goal": "總結 README.md", "ts": ts}),
        "\n",
        ...
        _model_section("LogLineEvent", LogLineEvent,
            {"type": "log.line", "run_id": run_id, "level": "INFO",
             "source": "agentx.core.loop", "message": "step 1 started", "ts": ts}),
        "\n## Session Events\n\n",
...
# 解析命令列引數，寫出或校驗 WIRE_PROTOCOL.md
def main() -> None:
