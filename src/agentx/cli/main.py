...
from agentx.cli.commands.chat import cmd_chat
from agentx.cli.commands.core import cmd_core_start, cmd_core_status, cmd_core_stop
from agentx.cli.commands.ping import cmd_ping
from agentx.cli.commands.run import cmd_run
from agentx.cli.commands.trace import cmd_trace
from agentx.cli.commands.version import cmd_version
from agentx.core.config import get_config
from agentx.core.logging_setup import setup_logging


# CLI 主入口：解析命令列引數並分發到對應子命令
def main() -> None:
    parser = argparse.ArgumentParser(prog="agentx", description="AgentX CLI")
