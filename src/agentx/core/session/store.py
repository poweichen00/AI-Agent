...
class SessionStore:
    ...
    # 批次追加一次 run 新產生的訊息到 thread.jsonl
    def append_messages(
        self,
        sid: str,
    ...
    # 讀取完整 thread 並返回可直接傳給 Anthropic 的 messages
    ...
    # 將壓縮後的訊息對覆蓋寫入 thread.jsonl，原檔案備份為 thread_<ts>.jsonl.bak
